    ...
    _initPages() {
        ...
        this.pageGroups = [
            ...
            new NavSystemPageGroup("MFD", this, [
                ...
                this._mfdPagesRight.ndbInfo = new NavSystemPage("NDB Info Right", "NDBInfoRight", new WT_G3x5_TSCNDBInfo("MFD", "MFD Home", "MFD", WT_G3x5_MFDHalfPane.ID.RIGHT, this.mfdRightPaneSettings.display)),
                ...
                this._mfdPagesLeft.checklist = new NavSystemPage("Checklist Info Left", "ChecklistLeft", new WT_G3x5_TSCAirportInfo("MFD", "MFD Home", "MFD", WT_G3x5_MFDHalfPane.ID.LEFT, this.mfdLeftPaneSettings.display)),
                this._mfdPagesRight.checklist = new NavSystemPage("Checklist Info Right", "ChecklistRight", new WT_G3x5_TSCAirportInfo("MFD", "MFD Home", "MFD", WT_G3x5_MFDHalfPane.ID.RIGHT, this.mfdRightPaneSettings.display))
            ]),
...
class AS3000_TSC_MFDHome extends NavSystemElement {
    ...
    _openTrafficSettingsPage() {
        this.gps.SwitchToPageName("MFD", this.gps.getSelectedMFDPanePages().trafficMap.name);
    }
