...
class WT_G3x5_MFDHalfPane {
    constructor(htmlElement, instrumentID, halfPaneID, data) {
        ...
        this._checklistPane = new WT_G3x5_ChecklistDisplayPane(this._createChecklistElement(id));
    ...
    _createChecklistElement(id) {
        return new WT_G3x5_ChecklistDisplay(id);
    }
