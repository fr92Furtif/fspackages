...
class WT_G3x5_MFDHalfPane {
    ...
    /**
     * @returns {WT_G3x5_Checklist}
     */
    _createChecklist(airplane) {
        return new WT_G3x5_Checklist(this.paneID);
    }
  ...
  /**
    ...
    _createPanes(data) {
        ...
        this._checklistPane = new WT_G3x5_ChecklistDisplayPane(this.paneID, this.settings, this._createChecklist(data.airplane));
    }
    ...
    async _initDisplayPanes() {
        ...
        this._checklistPane.init(this.htmlElement.querySelector(`.checklist`));
    }
        ...
        #wrapper {
            ...
            #titledpane {
                ...
                .content {
                    ...
                    #wrapper[active-view="checklist"] #checklist {
                        display: block;
                    }
