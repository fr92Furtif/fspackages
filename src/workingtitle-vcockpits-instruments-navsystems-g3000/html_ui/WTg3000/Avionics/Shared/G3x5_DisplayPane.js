...
class WT_G3x5_ChecklistDisplayPane extends WT_G3x5_DisplayPane {
    ...
    constructor(checklistElement) {
        super();
        this._checklistElement = checklistElement;
    }
    ...
    init(root) {
        this._checklistElement.init(root);
    }

    wake() {
        this._checklistElement.wake();
    }

    sleep() {
        this._checklistElement.sleep();
    }

    update() {
        this._checklistElement.update();
    }
